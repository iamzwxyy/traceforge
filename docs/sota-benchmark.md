...
Codex 的 [`compact.rs`](https://github.com/openai/codex/blob/6be2a6ca952ac9f70676ce4dd07fda27175aa9dd/codex-rs/core/src/compact.rs) 会生成替换历史并在上下文超限时继续回退；[`history.rs`](https://github.com/openai/codex/blob/6be2a6ca952ac9f70676ce4dd07fda27175aa9dd/codex-rs/core/src/context_manager/history.rs) 维护工具调用/结果配对并限制工具输出。DeepSeek 则把压缩和动态运行时上下文保存为可投影事件。
